...
#[doc = "Possible values of the field `FG_COMMAND_STARTED`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FG_COMMAND_STARTEDR {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
}
impl FG_COMMAND_STARTEDR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            FG_COMMAND_STARTEDR::CPE1 => true,
            FG_COMMAND_STARTEDR::CPE0 => false,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> FG_COMMAND_STARTEDR {
        match value {
            true => FG_COMMAND_STARTEDR::CPE1,
            false => FG_COMMAND_STARTEDR::CPE0,
        }
    }
    #[doc = "Checks if the value of the field is `CPE1`"]
    #[inline]
    pub fn is_cpe1(&self) -> bool {
        *self == FG_COMMAND_STARTEDR::CPE1
    }
    #[doc = "Checks if the value of the field is `CPE0`"]
    #[inline]
    pub fn is_cpe0(&self) -> bool {
        *self == FG_COMMAND_STARTEDR::CPE0
    }
}
#[doc = "Possible values of the field `COMMAND_STARTED`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMMAND_STARTEDR {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
}
impl COMMAND_STARTEDR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    pub fn bit_is_clear(&self) -> bool {
        !self.bit()
    ...
    pub fn bit(&self) -> bool {
        match *self {
            COMMAND_STARTEDR::CPE1 => true,
            COMMAND_STARTEDR::CPE0 => false,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> COMMAND_STARTEDR {
        match value {
            true => COMMAND_STARTEDR::CPE1,
            false => COMMAND_STARTEDR::CPE0,
        }
    }
    #[doc = "Checks if the value of the field is `CPE1`"]
    #[inline]
    pub fn is_cpe1(&self) -> bool {
        *self == COMMAND_STARTEDR::CPE1
    }
    #[doc = "Checks if the value of the field is `CPE0`"]
    #[inline]
    pub fn is_cpe0(&self) -> bool {
        *self == COMMAND_STARTEDR::CPE0
    }
}
...
#[doc = "Values that can be written to the field `FG_COMMAND_STARTED`"]
pub enum FG_COMMAND_STARTEDW {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
}
impl FG_COMMAND_STARTEDW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            FG_COMMAND_STARTEDW::CPE1 => true,
            FG_COMMAND_STARTEDW::CPE0 => false,
        }
    }
}
#[doc = r" Proxy"]
pub struct _FG_COMMAND_STARTEDW<'a> {
    w: &'a mut W,
}
impl<'a> _FG_COMMAND_STARTEDW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: FG_COMMAND_STARTEDW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn cpe1(self) -> &'a mut W {
        self.variant(FG_COMMAND_STARTEDW::CPE1)
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline]
    pub fn cpe0(self) -> &'a mut W {
        self.variant(FG_COMMAND_STARTEDW::CPE0)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `COMMAND_STARTED`"]
pub enum COMMAND_STARTEDW {
    #[doc = "Associate this interrupt line with INT_RF_CPE1 interrupt vector"]
    CPE1,
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    CPE0,
}
impl COMMAND_STARTEDW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            COMMAND_STARTEDW::CPE1 => true,
            COMMAND_STARTEDW::CPE0 => false,
        }
    }
}
#[doc = r" Proxy"]
pub struct _COMMAND_STARTEDW<'a> {
    w: &'a mut W,
}
impl<'a> _COMMAND_STARTEDW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: COMMAND_STARTEDW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn cpe1(self) -> &'a mut W {
        self.variant(COMMAND_STARTEDW::CPE1)
    }
    #[doc = "Associate this interrupt line with INT_RF_CPE0 interrupt vector"]
    #[inline]
    pub fn cpe0(self) -> &'a mut W {
        self.variant(COMMAND_STARTEDW::CPE0)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 13 - 13:13\\] Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline]
    pub fn fg_command_started(&self) -> FG_COMMAND_STARTEDR {
        FG_COMMAND_STARTEDR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 13;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
    }
    #[doc = "Bit 12 - 12:12\\] Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    #[inline]
    pub fn command_started(&self) -> COMMAND_STARTEDR {
        COMMAND_STARTEDR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        })
...
impl W {
    ...
    #[doc = "Bit 13 - 13:13\\] Select which CPU interrupt vector the RFCPEIFG.FG_COMMAND_STARTED interrupt should use."]
    #[inline]
    pub fn fg_command_started(&mut self) -> _FG_COMMAND_STARTEDW {
        _FG_COMMAND_STARTEDW { w: self }
    }
    #[doc = "Bit 12 - 12:12\\] Select which CPU interrupt vector the RFCPEIFG.COMMAND_STARTED interrupt should use."]
    #[inline]
    pub fn command_started(&mut self) -> _COMMAND_STARTEDW {
        _COMMAND_STARTEDW { w: self }
    }
    #[doc = "Bit 11 - 11:11\\] Select which CPU interrupt vector the RFCPEIFG.TX_BUFFER_CHANGED interrupt should use."]
    #[inline]
