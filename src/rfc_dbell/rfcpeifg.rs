...
#[doc = r" Value of the field"]
pub struct FG_COMMAND_STARTEDR {
    bits: bool,
}
...
impl R {
    ...
    #[doc = "Bit 13 - 13:13\\] Interrupt flag 13. IEEE 802.15.4 mode only: A foreground radio operation command has gone into active state."]
    #[inline]
    pub fn fg_command_started(&self) -> FG_COMMAND_STARTEDR {
        ...
        FG_COMMAND_STARTEDR { bits }
    }
    #[doc = "Bit 12 - 12:12\\] Interrupt flag 12. A radio operation command has gone into active state."]
    #[inline]
