...
pub struct RegisterBlock {
    ...
    #[doc = "Claim Tag Set Claim Tag Mask"]
    pub claimset: CLAIMSET_UNION,
    #[doc = "Claim Tag Clear Current Claim Tag"]
    pub claimclr: CLAIMCLR_UNION,
