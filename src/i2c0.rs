...
pub struct RegisterBlock {
    ...
    pub soar: SOAR,
    #[doc = "Slave Control\nNote: This register shares address with SSTAT, meaning that this register functions as a control register when written, and a status register when read. Slave Status \nNote: This register shares address with SCTL, meaning that this register functions as a control register when written, and a status register when read."]
    pub sctl: SCTL_UNION,
